...
description: "Plan, execute, and track multi-phase projects. Splits complex work into parallelizable phases, executes each via gg-single-phase-workflow in isolated worktrees, and tracks progress across sessions."
metadata:
