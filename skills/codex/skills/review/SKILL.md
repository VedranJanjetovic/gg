---
name: "review"
description: "Adversarial code review with severity-classified findings"
metadata:
  short-description: "Adversarial code review with severity-classified findings"
---
...
Review: $ARGUMENTS
If no arguments provided, review the current git diff (staged + unstaged changes).
